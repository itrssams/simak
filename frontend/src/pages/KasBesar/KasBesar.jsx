...
export default function KasBesar() {
    ...
    const handleLaporanKB = async () => {
        ...
        if (notaList.length === 0 && !hasExistingFiles) {
        ...
        try {
            ...
            showSuccess(modalLaporan.laporan ? 'Perbaikan laporan penggunaan kas besar berhasil disubmit!' : 'Laporan penggunaan kas besar berhasil disubmit!');
                                    ...
                                    <div style={{ marginBottom: 14, padding: '12px 14px', background: '#fffbeb', border: '1px solid #fde68a', borderRadius: 8 }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
                                            ...
                                            <span style={{
                                                ...
                                                color: modalDetail.reimbursement_info.status === 'dicairkan' ? '#166534' : '#92400e',
                                            }}>
                                                {modalDetail.reimbursement_info.status_display || modalDetail.reimbursement_info.status}
                                            </span>
                                        </div>
                                    </div>
                                )}
                                                ...
                                                {Number(modalDetail.laporan.diskon) > 0 && (
                                                    <>
                                                        <tr className="pc-items-tfoot-subtotal">
                                                            <td colSpan={2} className="label">Subtotal Belanja</td>
                                                        ...
                                                        <tr className="pc-items-tfoot-diskon">
                                                            <td colSpan={2} className="label">Potongan Diskon</td>
                                                            <td className="val">- {fmt(modalDetail.laporan.diskon)}</td>
                                                        </tr>
                                                    </>
                                                )}
                                                <tr className="pc-items-tfoot-total">
                                                    <td colSpan={2} className="label">Total Pengeluaran Riil</td>
